...
/**
 * Cross-subtype read model of a ticket: the shared fields plus the
 * {@link TicketType} discriminator and the subtype's display number. Carries no
 * subtype-specific field (e.g. {@code Incident.relatedProblemId}) — those live
 * on the subtype's own resource, reachable via the type-named link relation.
 */
